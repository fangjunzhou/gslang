...
class Renderer:
    ...
    def render(self, 
               ...
               gaussian_opacity_remove_threshold: float = 0.1
               ) -> float:
        ...
        if use_correction:
            self.run_correction(gaussian_opacity_remove_threshold=gaussian_opacity_remove_threshold)
    ...
    def recalcuate_avg_3dgs_size(self):
